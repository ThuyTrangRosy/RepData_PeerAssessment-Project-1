...
: I used a strategy for filing in all missing values with the mean for that 5-minute interval. First, I made a function **"interval2steps"** to get the mean steps for the particular 5-minute interval. 
```{r echo=TRUE}
...
```{r echo=TRUE}
stepsInterval2=aggregate(steps~interval+day,activity-filled,mean)
library(lattice)
